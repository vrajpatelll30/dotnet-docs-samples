...
namespace ModelArmor.Samples.Tests
{
    public class UpdateTemplateWithMetadataTests : IClassFixture<ModelArmorFixture>
    {
        ...
        private readonly UpdateTemplateWithMetadataSample _sample;
        private readonly ITestOutputHelper _output;

        public UpdateTemplateWithMetadataTests(ModelArmorFixture fixture, ITestOutputHelper output)
        {
            _fixture = fixture;
            _sample = new UpdateTemplateWithMetadataSample();
            _output = output;
        }
        ...
        public void UpdateTemplateWithMetadataTest()
        {
            ...
            // Verify the metadata
            Assert.NotNull(originalTemplate.TemplateMetadata);
            Assert.True(originalTemplate.TemplateMetadata.LogTemplateOperations);
            Assert.True(originalTemplate.TemplateMetadata.LogSanitizeOperations);
            ...
            Template updatedTemplate = _sample.UpdateTemplateWithMetadata(
        ...
        public void UpdateTemplateTest_NonExistentTemplate_ThrowsException()
        {
            ...
            var exception = Assert.Throws<Grpc.Core.RpcException>(() =>
                _sample.UpdateTemplateWithMetadata(
                    projectId: _fixture.ProjectId,
                    locationId: _fixture.LocationId,
